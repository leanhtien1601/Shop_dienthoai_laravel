                                ...
                                <form id="demo-form2" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input type="text"  class="form-control" name="name_cate" value="{{$objDemo->name_cate}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <img src="../../../../public/image/{{$objDemo->images}}" alt=""
                                                 style="max-width: 150px;max-height: 150px;"> <hr>
                                            <input type="file"  class="form-control" name="images" value="{{$objDemo->images}}">
                                        </div>
