                                ...
                                <form  class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input type="text" class="form-control" name="name_pro" value="{{$objDemo->name_pro}}">
                                        </div>
                                    </div>

                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Ảnh slider<span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 ">
                                            <img src="../../../../public/image/{{$objDemo->image}}" alt="" style="max-width: 150px;max-height: 150px;">
                                            <hr>
                                    ...
                                    <div class="item form-group">
                                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">link đường dẫn</label>
                                        <div class="col-md-6 col-sm-6 ">
                                            <input  class="form-control" type="text" name="link_product" value="{{$objDemo->link_product}}">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        <label for="last-name" class="col-form-label col-md-3 col-sm-3 label-align">Trạng thái</label>

                                        <input type="number" name="status" max=1 min=0 class="form-control" value="{{$objDemo->status}}" >
                                    </div>
                                    <div class="item form-group">

                                        <p>Chọn 1 để đăng hoặc 0 để chưa đăng</p>
